...
class AlbumListBloc extends BLoCScaffold with BLoCLifeCycle {
  ...
  void refresh() {
    ...
    //       }
    //
    //       final list = <AlbumFolder>[];
    //       list.add(AlbumFolder(PluginFolder(
    //         null, 'All', (await ZpdlStudioMediaPlugin.getImageFolderCount(null) ?? 0)
...
class AlbumFolder {
  ...
  AlbumFolder(this.folder, {bool selected = false}): selected = selected;
}
